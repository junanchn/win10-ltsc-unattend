...
echo --- WinSxS Backup + Temp ---
takeown /f "%SystemRoot%\WinSxS\Backup" /r /d y >nul
icacls "%SystemRoot%\WinSxS\Backup" /grant Administrators:F /t >nul
rd /s /q "%SystemRoot%\WinSxS\Backup"
takeown /f "%SystemRoot%\WinSxS\Temp" /r /d y >nul
icacls "%SystemRoot%\WinSxS\Temp" /grant Administrators:F /t >nul
rd /s /q "%SystemRoot%\WinSxS\Temp"
echo.
...
call :RmDir "C:\ProgramData\Package Cache"
echo.

echo --- .NET NGen Cache ---
for /d %%D in ("%SystemRoot%\assembly\NativeImages_v*") do call :RmDir "%%D"
call :RmDir "%SystemRoot%\assembly\temp"
call :RmDir "%SystemRoot%\assembly\tmp"
echo.
...
if !errorlevel! NEQ 0 (
    if exist "C:\ProgramData\Microsoft\Windows Defender" (
        ...
        icacls "C:\ProgramData\Microsoft\Windows Defender" /grant Administrators:F /t >nul
...
echo --- Edge Update + Diagnostic Data ---
call :RmDir "C:\ProgramData\Microsoft\EdgeUpdate"
call :RmDir "C:\ProgramData\Microsoft\DiagnosticLogCSP"
echo.
...
call :DelFiles "C:\Windows\*.bak"
call :DelFiles "C:\Windows\*log.txt"
call :DelFiles "C:\Windows\*.tmp"
call :DelFile "C:\Windows\SchedLgU.txt"
...
call :RmDir "C:\Windows\Performance\WinSAT\DataStore"
call :DelFiles "C:\Windows\Performance\WinSAT\*.log"
call :RmDir "C:\Logs"
call :CleanDir "C:\Windows\System32\WDI\LogFiles"
call :CleanDir "C:\Windows\System32\LogFiles"
for /d %%U in ("C:\Users\*") do (
    call :DelFiles "%%U\AppData\Local\Microsoft\Windows\*.log"
    call :DelFiles "%%U\AppData\Local\MigWiz\*.log"
    call :DelFiles "%%U\AppData\Roaming\Microsoft\Windows\*.log"
    for /d %%C in ("%%U\AppData\Local\Microsoft\CLR_*") do call :DelFiles "%%C\*.log"
)
echo.
...
del /q /f "C:\Windows\Logs\CBS\*.log" >nul
del /q /f "C:\Windows\Logs\CBS\*.cab" >nul
del /q /f "C:\Windows\Logs\DISM\*.log" >nul
